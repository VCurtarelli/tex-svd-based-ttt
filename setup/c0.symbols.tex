...
\NewDocumentCommand{\srf}{m}{%
	\xi_{#1}
}
\MakeSymbol{\tD}{\tilde{D}}
\MakeSymbol{\dsrf}{\text{DSRF}}
\MakeSymbol{\uprf}{\text{UPRF}}
\MakeSymbol{\nsrf}{\srf{\eta}}
\MakeSymbol{\gsnr}{\text{gSNR}}
\MakeSymbol{\gsir}{\text{gSIR}}
\MakeSymbol{\df}{\text{DF}}
\MakeSymbol{\wng}{\text{WNG}}
