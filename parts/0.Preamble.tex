...
\author{%
	...
	%
	\thanks{\ieee Manuscript Info. Corresponding author: Vitor G. P. Curtarelli.}%
	\thanks{V. G. P. Curtarelli, UFSC, Brazil (\url{vitor.curtarelli@posgrad.ufsc.br}).}%
	\thanks{A. W. Spengler, UFSC, Brazil (\url{anderson.spengler@ufsc.br}).}%
	\thanks{S. Paul, UFSC, Brazil (\url{stephan.paul@ufsc.br}).}%
	%
}
