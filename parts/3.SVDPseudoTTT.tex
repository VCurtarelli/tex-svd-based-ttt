...
In general, the smaller a singular value $\lambda_n$ is, the lessened its impact will be on the reconstruction of $\bvR{i}$, and thus in the minimization problem. However, its impact on the estimation of $\bvs{i+1}$ will be increased by the p-inverse, over-representing the corresponding bases vectors, and possibly leading to overfitting \cite{vallet_solving_1989,nittscher_svddip_2023,kim_regularization_2025}.
